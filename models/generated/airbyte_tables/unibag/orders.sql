...
select
    ...
    {{ adapter.quote('inventory') }}::json->'_id'::text AS inventory_id,
    {{ adapter.quote('inventory') }}::json->'name'::text AS inventory_name,
    {{ adapter.quote('payment') }}::json->'method'::text AS payment_method,
    {{ adapter.quote('payment') }}::json->'status'::text AS payment_status,
    ...
    delivery::json->'status'::text AS delivery_status,
