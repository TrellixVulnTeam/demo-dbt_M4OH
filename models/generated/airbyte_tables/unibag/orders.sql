...
select
    ...
    -- to_date(level::json->>'expiredAt', 'YYYY-MM-DDTHH24:MI:SSZ')
    to_date(approvedat, 'YYYY-MM-DDTHH24:MI:SSZ') AS approved_at,
    to_date(rejectedat, 'YYYY-MM-DDTHH24:MI:SSZ') AS rejected_at,
    to_date(pickupat, 'YYYY-MM-DDTHH24:MI:SSZ') AS pickup_at,
    to_date(deliveredat, 'YYYY-MM-DDTHH24:MI:SSZ') AS delivered_at,
    to_date(createdat, 'YYYY-MM-DDTHH24:MI:SSZ') AS created_at,
    to_date(updatedat, 'YYYY-MM-DDTHH24:MI:SSZ') AS updated_at,
